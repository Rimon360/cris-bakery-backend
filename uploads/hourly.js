async function main(imageOutputDir, _START_DATE, _END_DATE, _START_TIME, _END_TIME, _LABOR_COST_TARGET) {
    ...
    try {
        ...
        console.log(`Labor target: ${LABOR_COST_TARGET}%`);
        ...
        console.log(`Processed ${chartData.length} time periods`);
