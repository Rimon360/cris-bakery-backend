async function main(imageOutputDir, _START_DATE, _END_DATE) {
    ...
    console.log('Configuration:', { START_DATE, END_DATE });
    // ==================================================================
    ...
    try {
        ...
        if (excelData.length === 0) {
            console.log('ERROR: No data loaded from Excel file!');
            return;
        }
        ...
        if (Object.keys(dailyData).length === 0) {
            console.log('\nERROR: No data matched the date range!');
            console.log('Check that your START_DATE and END_DATE match the dates in your file.');
            return;
        }
